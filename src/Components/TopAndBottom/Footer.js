    ...
    <div className="lg:flex lg:items-start lg:gap-8">
      ...
      <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
        <div className="col-span-2">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Bharat Rites</h2>
        ...
        <div className="col-span-2 sm:col-span-1">
          ...
          <ul className="mt-6 space-y-4 text-sm">
            ...
            <li>
            <Link to="/whoweare" className="text-gray-700 transition hover:opacity-75"> About Us </Link>
            </li>

            <li>
            <Link to="/membership" className="text-gray-700 transition hover:opacity-75"> Membership </Link>
            </li>
            ...
            <li>
            <Link to="/news" className="text-gray-700 transition hover:opacity-75"> News & Updates </Link>
            </li>
          </ul>
        </div>
